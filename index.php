...
<body>
    ...
    <div id= "right">
        ...
        <input type="text" name= "fullname" placeholder= "Enter your fullname" required id= "fullname"> <br><br>

        <input type="email" name= "email" id= "email" placeholder= "Enter your email" required> <br><br>

        <input type="number" name= "number" id= "number" placeholder= "Enter your phone number" required> <br><br>
        ...
        <input type="text" name="add" id= "add" placeholder= "Enter your home address" required> <br> <br>
